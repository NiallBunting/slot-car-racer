...
${OBJECTDIR}/gaussian_nomain.o: ${OBJECTDIR}/gaussian.o gaussian.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gaussian_nomain.o gaussian.cpp;\
	else  \
...
${OBJECTDIR}/image_nomain.o: ${OBJECTDIR}/image.o image.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/image_nomain.o image.cpp;\
	else  \

...
${OBJECTDIR}/car.o: car.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/opencv2 `pkg-config --cflags opencv` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/car.o car.cpp
...
${OBJECTDIR}/cardetector.o: cardetector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/opencv2 `pkg-config --cflags opencv` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cardetector.o cardetector.cpp
...
${TESTDIR}/tests/cartest.o: tests/cartest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/opencv2 -I. `pkg-config --cflags opencv` -std=c++11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/cartest.o tests/cartest.cpp
...
${OBJECTDIR}/car_nomain.o: ${OBJECTDIR}/car.o car.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/include/opencv2 `pkg-config --cflags opencv` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/car_nomain.o car.cpp;\
	else  \
...
${OBJECTDIR}/cardetector_nomain.o: ${OBJECTDIR}/cardetector.o cardetector.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/include/opencv2 `pkg-config --cflags opencv` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cardetector_nomain.o cardetector.cpp;\
	else  \
